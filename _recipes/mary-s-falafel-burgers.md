...
layout: recipe
title: Mary's falafel burgers
image: mary-s-falafel-burgers.webp
original_url: https://www.sbs.com.au/food/recipe/marys-falafel-burgers/jnfqsh6wd
# ---
tags:
- mains
- vegetarian
description: Pair these golden-brown vegetarian falafel burger patties with a creamy tahini sauce and serve in burger buns
  or pita.
yield: 4 servings
prep_time: '10'
ingredients:
...
# ---
directions:
- Drain the chickpeas and transfer to the bowl of your food processor. Add in the garlic, green onions, parsley, coriander,
...
- After the falafel mixture has chilled, divide into four equal pieces and shape into burgers roughly the same size as your
  buns.
- Heat the oil in a high-sided skillet over medium-high heat to 190°C (170°C fan forced). Fry the falafel burgers until golden
  brown, about 3 to 4 minutes per side, reducing the heat if the burgers are browning too quickly.
- Serve the falafel burgers on the buns topped with sprouts or lettuce, tomato, pickled onion, tahini sauce and feta.
# ---
notes:
